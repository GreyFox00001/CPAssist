...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(120,119,198,0.16),_transparent_35%),linear-gradient(180deg,_var(--background),_color-mix(in_oklab,var(--background)_85%,white))] px-6 py-10">
