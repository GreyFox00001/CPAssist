...
export default function SignupPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_right,_rgba(34,197,94,0.16),_transparent_30%),linear-gradient(180deg,_var(--background),_color-mix(in_oklab,var(--background)_84%,white))] px-6 py-10">
